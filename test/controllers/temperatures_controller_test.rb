...
class TemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post temperatures_url, params: { temperature: { city_id: @temperature.city_id, humidity: @temperature.humidity, pressure: @temperature.pressure, temp: @temperature.temp, temp_max: @temperature.temp_max, temp_min: @temperature.temp_min } }
    end
  ...
  test "should update temperature" do
    patch temperature_url(@temperature), params: { temperature: { city_id: @temperature.city_id, humidity: @temperature.humidity, pressure: @temperature.pressure, temp: @temperature.temp, temp_max: @temperature.temp_max, temp_min: @temperature.temp_min } }
